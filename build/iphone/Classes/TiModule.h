...
/**
 The base class for all Stuk modules
 */
...
/**
 Stuk Platform calls this method on startup.
 */
-(void)startup;

/**
 Stuk Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Stuk Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Stuk Platform calls this method on resume.
 @param sender The sender of the event.
 */
