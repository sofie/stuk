...
// in simulator we redefine to format for Stuk Developer console
...
{\
	NSString * exceptionName = [@"org.stuk." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.stuk";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIStukNativeItemNone = -1, 
	UIStukNativeItemSpinner = -2,
	UIStukNativeItemProgressBar = -3,
	
	UIStukNativeItemSlider = -4,
	UIStukNativeItemSwitch = -5,
	UIStukNativeItemMultiButton = -6,
	UIStukNativeItemSegmented = -7,
	
	UIStukNativeItemTextView = -8,
	UIStukNativeItemTextField = -9,
	UIStukNativeItemSearchBar = -10,
	
	UIStukNativeItemPicker = -11,
	UIStukNativeItemDatePicker = -12,
	
	UIStukNativeItemInfoLight = -13,
	UIStukNativeItemInfoDark = -14,
	
	UIStukNativeItemDisclosure = -15,
	
	UIStukNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Stuk instances of
