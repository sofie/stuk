 ...
 * Copyright (c) 2009-2011 by Stuk, Inc. All Rights Reserved.
...
//@interface StukObject : NSObject
//@end

@interface StukObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[StukObject class]])
		{
			for (NSString *key in [[(StukObject*)o modules] allKeys])
			{
